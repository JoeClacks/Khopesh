...
class Event(base.Event):    
    ...
    def move(self, position):
        ...
        distance = (self.data['avatarX'] - position[0])**2 \
                + (self.data['avatarY'] - position[1])**2 \
                + (self.data['avatarZ'] - position[2])**2
        ...
        self.data['avatarX'] = position[0]
        self.data['avatarY'] = position[1]
        self.data['avatarZ'] = position[2]
    ...
    def tryCommandMove(self, lvl, stateDiff):
        ...
        distance = (self.data['avatarX'] - lvl.data['cellIdX'])**2 +\
            (self.data['avatarY'] - lvl.data['cellIdY'])**2 +\
            (self.data['avatarZ'] - lvl.data['levelIdZ'])**2
